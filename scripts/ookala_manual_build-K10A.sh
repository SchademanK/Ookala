...
BASEDIR=/disk1/usr/local/ookala
...
K10A="--with-k10a \
	--with-k10a-headers=$BASEDIR/include \
	--with-k10a-libs=$BASEDIR/$LIB"
...
X11FLAGS="--with-x --x-includes=/usr/include/X11 --x-libraries=/usr/$LIB"
